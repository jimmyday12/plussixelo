# Getting help with plussixelo

Thanks for using plussixelo. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/plussixelo/issues) to make sure the 
